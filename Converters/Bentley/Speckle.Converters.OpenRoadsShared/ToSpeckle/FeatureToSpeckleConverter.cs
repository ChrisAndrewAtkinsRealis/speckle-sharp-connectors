...
/// <summary>
/// Converts a civil featurized model entity (feature line / linear or point feature) to a DataObject:
/// display geometry plus its feature name/definition.
/// </summary>
[NameAndRankValue(typeof(CifGM.FeaturizedModelEntity), NameAndRankValueAttribute.SPECKLE_DEFAULT_RANK)]
public class FeatureToSpeckleConverter(
...
{
  public Base Convert(object target) => Convert((CifGM.FeaturizedModelEntity)target);

  public DataObject Convert(CifGM.FeaturizedModelEntity target)
  {
    ...
    {
      name = properties.TryGetValue("featureName", out var fn) ? fn?.ToString() ?? "Feature" : "Feature",
